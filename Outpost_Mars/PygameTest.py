...
DISPLAYSURF.blit(gif_64[1], gridDict_rect[(1, 1, 0)])
DISPLAYSURF.blit(gif_64[0], gridDict_rect[(3, 9, 0)])
DISPLAYSURF.blit(gif_64[2], gridDict_rect[(4, 5, 0)])
DISPLAYSURF.blit(gif_64[3], gridDict_rect[(8, 8, 0)])
DISPLAYSURF.blit(gif_64[4], gridDict_rect[(7, 3, 0)])
